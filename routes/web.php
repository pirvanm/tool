...
Route::group(['middleware' => ['get.menu', 'role:admin']], function () {
    ...
    Route::get('/admin.chartjson', [DashBoardController::class, 'getCharJsData']);
    Route::get('/admin/entries.datatable', [EntriesController::class, 'datatable'])->name('entries.datatable');
    Route::get('/admin/entries', [EntriesController::class, 'index'])->name('entries.index');
